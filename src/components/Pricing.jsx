  ...
  const data = [
    {
      ...
      desc: [
        ...
        "exploring their creativity with",
        " Adobe Firefly.",
      ],
      validity: "per month",
    ...
    },
    {
      ...
      desc: [
        ...
        " need advanced tools and full",
        " AI capabilities for their",
        " creative projects.",
      ],
    ...
    },
    {
      ...
      desc: [
        " Tailored for large teams and",
        " enterprises that require full",
    ...
    <>
      <div className="h-screen w-full flex items-center justify-center overflow-hidden flex-col bg-black text-white ">
        ...
        <TextIntersectionObserver
          children={["Manufacturing measured,", " in weeks, not months"]}
        ...
        <div className=" h-[60vh]   max-sm:h-[50vh] w-[60%]  sm:text-start   flex justify-between  items-bottom max-sm:flex-col  gap-5  ">
          {data.map((item, index) => (
            ...
            >
              <Paragraph
                phrases={[item.title]}
                className={"text-2xl  max-sm:text-sm font-['aeronaut']"}
              />

              <div className=" flex justify-center items-end gap-2 font-['aeronaut'] ">
              ...
              <div className=" gap-[.5vw] flex flex-col ">
                <div className="flex items-center gap-2">
                  ...
                  <div className=" flex  items-center gap-2 font-['sussi'] ">
              ...
              <Button
                ...
                circ={"bg-white"}
                customclass={` w-fit mx-auto mt-[2vh] font-['sussi']  bg-transparent border-[1px] text-xs`}
              />
            </div>
            // </GlassmorphismDiv>
          ))}
